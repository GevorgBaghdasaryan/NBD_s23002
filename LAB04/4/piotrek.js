...
db.people.mapReduce(mapFunc, reduceFunc, {
    out: 'minimalne_i_maksymalne_BMI_w_podziale_na_narodowosc',
    finalize: finalizeFunc,
});

printjson(db.minimalne_i_maksymalne_BMI_w_podziale_na_narodowosc.find().pretty().toArray())
